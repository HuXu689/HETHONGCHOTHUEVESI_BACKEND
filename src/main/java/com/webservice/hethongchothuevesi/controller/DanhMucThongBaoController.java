...
public class DanhMucThongBaoController {
    ...
    @PostMapping
    public ResponseEntity<DanhMucThongBaoDTO> createDanhMucThongBao(@RequestBody DanhMucThongBaoDTO danhMucThongBaoDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DanhMucThongBaoDTO> updateDanhMucThongBao(@PathVariable Integer id, @RequestBody DanhMucThongBaoDTO dto) {
