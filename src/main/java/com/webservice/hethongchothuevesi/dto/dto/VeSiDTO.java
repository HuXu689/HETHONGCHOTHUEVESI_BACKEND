...
public class VeSiDTO {
    ...
    public VeSiDTO(Integer idVeSi, Integer idNguoiDung, String hoTen, Integer kinhNghiem, String thongTinDanhGiaChung,
                   String emailVeSi, LocalDate ngaySinhVeSi, String gioiTinhVeSi, String sdtVeSi,
                   LocalDate ngayBatDauLam, String capBac, LocalDate ngayLenCap,
                   BigDecimal luong, String trangThai, LocalDateTime ngayXoa) {
        this.idVeSi = idVeSi;
    ...
    public VeSiDTO(Integer idVeSi, Integer idNguoiDung, String hoTen, Integer kinhNghiem, String thongTinDanhGiaChung,
                   ...
                   LocalDate ngayBatDauLam, String capBac, LocalDate ngayLenCap,
                   BigDecimal luong, String trangThai, LocalDateTime ngayXoa,
                   Double trungBinhKyNangChuyenMon, Double trungBinhXuLyTinhHuong,
                   Double trungBinhThaiDoDaoDuc, Double trungBinhGiaoTiep,
                   Double trungBinhNgoaiHinh) {
        this(idVeSi, idNguoiDung, hoTen, kinhNghiem, thongTinDanhGiaChung, emailVeSi, ngaySinhVeSi,
                gioiTinhVeSi, sdtVeSi, ngayBatDauLam, capBac, ngayLenCap, luong, trangThai, ngayXoa);
