...
public class EmailService {
    ...
    public void sendPasswordResetLink(String emailTo, String resetToken)
            throws MessagingException, UnsupportedEncodingException {
        log.info("Đang gửi liên kết đặt lại mật khẩu tới email: {}", emailTo);
        ...
        String resetLink = String.format("%s/DoiMatKhauQuen?token=%s", serverLocal, resetToken);
        ...
        mailSender.send(message);
        log.info("Liên kết đặt lại mật khẩu đã được gửi tới email: {}", emailTo);
    }
}
