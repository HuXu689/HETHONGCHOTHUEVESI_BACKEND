...
public enum ErrorCode {
    ...
    NGUOIDUNG_NOT_EXISTED(1004, "Không tìm thấy người dùng"),
    NGUOIDUNG_ID_NOT_EXISTED(1004, "Không tìm thấy ID người dùng"),
    NGUOIDUNG_NOT_DELETED(1005, "Khách hàng chưa được xóa"),
